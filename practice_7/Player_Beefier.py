...
class Player_Beefier:
    def __init__(self, name="beefier"):
        self.name = name
        self.log = ""
        self.cards = []
        self.coins = 0
        self.cb_turn = 0
        try:
            old_memory = open("Player_Beefier.pkl", "rb")
    ...
    def receive(self, message):
        ...
        if message[:7] == "winner:":
            ...
            memory_file = open("Player_Beefier_memory.pkl", "wb")
...
if __name__ == '__main__':
    old_memory = open("Player_Beefier_memory.pkl", "rb")
