# -*- coding: utf-8 -*-
"""
Created on Sat Jul 16 20:09:13 2022
...
# BeatBeef
# strategy:
# always claim to have a duke to get Beef to income (tax and block foreign aid)
...
class Player_Beefeted:
    def __init__(self, name="beefeted"):
        self.name = name
        self.log = ""
        self.cards = []
        self.coins = 0
